...
abstract class CalificacionMensual extends _i1.SerializableEntity {
  ...
  factory CalificacionMensual.fromJson(
    Map<String, dynamic> jsonSerialization,
    _i1.SerializationManager serializationManager,
  ) {
    return CalificacionMensual(
      id: serializationManager.deserialize<int?>(jsonSerialization['id']),
      calificacionId: serializationManager
          .deserialize<int>(jsonSerialization['calificacionId']),
      calificacion: serializationManager
          .deserialize<_i2.Calificacion?>(jsonSerialization['calificacion']),
      numeroDeMes: serializationManager
          .deserialize<int>(jsonSerialization['numeroDeMes']),
      numeroDeAnio: serializationManager
          .deserialize<int>(jsonSerialization['numeroDeAnio']),
    );
  }
