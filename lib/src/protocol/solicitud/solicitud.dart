...
abstract class Solicitud extends _i1.SerializableEntity {
  Solicitud._({
    this.id,
  ...
  factory Solicitud.fromJson(
    Map<String, dynamic> jsonSerialization,
    _i1.SerializationManager serializationManager,
  ) {
    return Solicitud(
      id: serializationManager.deserialize<int?>(jsonSerialization['id']),
      tipoSolicitud: serializationManager
          .deserialize<_i2.TipoSolicitud>(jsonSerialization['tipoSolicitud']),
      idAutor:
          serializationManager.deserialize<int>(jsonSerialization['idAutor']),
      idDestinatario: serializationManager
          .deserialize<int>(jsonSerialization['idDestinatario']),
      fechaCreacion: serializationManager
          .deserialize<DateTime>(jsonSerialization['fechaCreacion']),
      fechaRealizacion: serializationManager
          .deserialize<DateTime?>(jsonSerialization['fechaRealizacion']),
      fechaVisto: serializationManager
          .deserialize<DateTime?>(jsonSerialization['fechaVisto']),
