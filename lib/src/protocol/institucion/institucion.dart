...
abstract class Institucion extends _i1.SerializableEntity {
  Institucion._({
    this.id,
  ...
  factory Institucion.fromJson(
    ...
    return Institucion(
      ...
      tipo: serializationManager
          .deserialize<_i2.TipoDeInstitucion>(jsonSerialization['tipo']),
