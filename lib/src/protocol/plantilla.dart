...
abstract class PlantillaComunicacion extends _i1.SerializableEntity {
  ...
  factory PlantillaComunicacion.fromJson(
    ...
    return PlantillaComunicacion(
      ...
      nota: serializationManager.deserialize<String>(jsonSerialization['nota']),
      necesitaSupervision: serializationManager
          .deserialize<bool>(jsonSerialization['necesitaSupervision']),
