...
abstract class SupervisionDeCurso extends _i1.SerializableEntity {
  ...
  factory SupervisionDeCurso.fromJson(
    ...
    return SupervisionDeCurso(
      ...
      fechaDeNotificacion: serializationManager
          .deserialize<DateTime?>(jsonSerialization['fechaDeNotificacion']),
    );
  }
